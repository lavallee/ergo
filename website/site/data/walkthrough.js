window.__ERGO_WALK__ = {
  ...
  "steps": [
    ...
    },
    {
      ...
      "stdout": "docs/data/ridgeway-311.md:57: error: effect must be one of ['breaks', 'corrupts', 'misleads', 'context'], got 'annoying'\ndocs/data/ridgeway-311.md:57: error: issue needs a [issue.scope] table with at least one key (or all = true)\n1 page(s), 1 issue(s), 0 practice(s): 2 error(s), 0 warning(s)",
      "exit_code": 1,
      "refused": true,
      "tree": [
        {
      ...
      "record": {
        ...
        "text": "docs/data/ridgeway-311.md:57: error: effect must be one of ['breaks', 'corrupts', 'misleads', 'context'], got 'annoying'\ndocs/data/ridgeway-311.md:57: error: issue needs a [issue.scope] table with at least one key (or all = true)\n1 page(s), 1 issue(s), 0 practice(s): 2 error(s), 0 warning(s)",
        "path": "$ output",
        "lang": "text"
      }
    },
    ...
    },
    {
      ...
      "stdout": "docs/data/ridgeway-311.md:81: warning: issue ward-renumbering is misleads but names no misuse\n1 page(s), 2 issue(s), 0 practice(s): 0 error(s), 1 warning(s)",
      "exit_code": 0,
      "refused": false,
      "tree": [
        {
      ...
      "record": {
        ...
        "text": "docs/data/ridgeway-311.md:81: warning: issue ward-renumbering is misleads but names no misuse\n1 page(s), 2 issue(s), 0 practice(s): 0 error(s), 1 warning(s)",
        "path": "$ output",
        "lang": "text"
      }
    },
    ...
    },
    {
      ...
      "stdout": "warning: docs/data/ridgeway-311.md:104: mitigated issue ridgeway-311/response-zero-unrecorded has no 'ergo: ridgeway-311/response-zero-unrecorded' anchor in its handled_by files\n1 page(s), 3 issue(s), 0 practice(s): 0 error(s), 1 warning(s)",
      "exit_code": 0,
      "refused": false,
      "tree": [
        {
      ...
      "record": {
        ...
        "text": "warning: docs/data/ridgeway-311.md:104: mitigated issue ridgeway-311/response-zero-unrecorded has no 'ergo: ridgeway-311/response-zero-unrecorded' anchor in its handled_by files\n1 page(s), 3 issue(s), 0 practice(s): 0 error(s), 1 warning(s)",
        "path": "$ output",
        "lang": "text"
      }
    },
    ...
    },
    {
      ...
      "stdout": "error: tools/load_311.py:14: anchor 'ergo: ridgeway-311/response-zero-unrecorded' names an unknown issue\nwarning: docs/data/ridgeway-311.md:104: mitigated issue ridgeway-311/response-hours-zero has no 'ergo: ridgeway-311/response-hours-zero' anchor in its handled_by files\n1 page(s), 3 issue(s), 0 practice(s): 1 error(s), 1 warning(s)",
      "exit_code": 1,
      "refused": true,
      "tree": [
        {
    ...
    },
    {
      ...
      "narrative": "A caveat you have not tested is a hypothesis. Validation records are dated and quantified — reconciliation against an independent publication, or confirmation of a claim against real files — and they accumulate: never edit an old record, add a new one. The numbers are what let the *next* check detect drift.",
      "spec": "8",
      "commands": [
        "python3 tools/ergo.py check docs/data --repo ."
      ],
